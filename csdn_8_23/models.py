...
class User():
    ...
    def __init__(self,username,password=None):
        if password is None:
            ...
            # 将数据存储到变量中
            self.id = self.username_pwd_record[0]
            self.username = self.username_pwd_record[1]
            self.nickname = self.username_pwd_record[2]
            self.password = self.username_pwd_record[3]
            self.avatar = self.username_pwd_record[4]
            self.status =self.username_pwd_record[5]
            self.is_super = self.username_pwd_record[6]
            self.created_at = self.username_pwd_record[7]
            self.updated_at = self.username_pwd_record[8]
    ...
    def get_name_pwd_record(self):
        print(self.username_record)
        return self.username_pwd_record

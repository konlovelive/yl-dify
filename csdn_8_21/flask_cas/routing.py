...
def login():
    ...
    to login. Second, it is used by the flask_cas to respond with the
    `ticket` after the user logs in successfully.

    When the user accesses this url, they are redirected to the flask_cas
    to login. If the login was successful, the flask_cas will respond to this
...
def validate(ticket):
    ...
    try:
        ...
        current_app.logger.error("flask_cas returned unexpected result")

...
Functions for creating urls to access flask_cas.
"""
...
def create_cas_login_url(cas_url, cas_route, service, renew=None, gateway=None):
    """ Create a flask_cas login URL .

    Keyword arguments:
    cas_url -- The url to the flask_cas (ex. http://sso.pdx.edu)
    cas_route -- The route where the flask_cas lives on server (ex. /cas)
...
def create_cas_logout_url(cas_url, cas_route, service=None):
    """ Create a flask_cas logout URL.

    Keyword arguments:
    cas_url -- The url to the flask_cas (ex. http://sso.pdx.edu)
    cas_route -- The route where the flask_cas lives on server (ex. /cas/logout)
...
def create_cas_validate_url(cas_url, cas_route, service, ticket,
                            renew=None):
    """ Create a flask_cas validate URL.

    Keyword arguments:
    cas_url -- The url to the flask_cas (ex. http://sso.pdx.edu)
    cas_route -- The route where the flask_cas lives on server (ex. /cas/serviceValidate)
    service -- (ex.  http://localhost:5000/login)
